...
GtkWidget *fm_tomate= lookup_widget(button,"spinbutton26");
GtkWidget *fm_carotte= lookup_widget(button,"spinbutton25");
GtkWidget *fm_epinard= lookup_widget(button,"spinbutton24");
GtkWidget *fm_pomme_de_terre= lookup_widget(button,"spinbutton23");
GtkWidget *fm_artichaud= lookup_widget(button,"spinbutton22");
GtkWidget *fm_brocoli= lookup_widget(button,"spinbutton21");
...
strcat(texte3," dt");
output=lookup_widget(button,"label205");
